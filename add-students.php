...
$sql="INSERT INTO  tblstudents(StudentName,RollId,StudentEmail,Gender,ClassId,DOB,Status,fees_status) VALUES(:studentname,:roolid,:studentemail,:gender,:classid,:dob,:status,:fees_status)";
...
$query->bindparam('fees_status',$fees_status,PDO::PARAM_STR);
$query->execute();
