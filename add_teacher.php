...
<body>
	<div id="brandname" class="myclass text-center">
        <h2 id="vjeera"><font color="crimson">SVIP</font> Latur</h2>
	...
	<div class="container">
		<form  class="well" method="post">
			<div class="form-group text-center heading abc" >
				...
				<input type="password" name="text" class="form-control  text-capitalize">
			</div> -->
			...
			<a type="button" class='btn btn-info' href="index.php" style='color:white'>HOME</a>	
			</div>
				...
				if(isset($_POST['create_user']))
				{
					...
					$query="insert into teachers(fname,lname,UserName,email,Password) values('$fname','$lname','$uname','$email','$phone')";
